...
// recharts (the heaviest client dependency here) loads only when a report
// actually renders a chart block. Fixed-height placeholder so the print-mode
// layout wait (2xrAF+250ms) doesn't snapshot a shifting page.
const Chart = dynamic(() => import('./chart-block'), {
  ssr: false,
  loading: () => <div className="rpt-chart-container" style={{ height: 340 }} />,
})
