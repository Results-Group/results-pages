  ...
  return (
    <div dir="rtl" className="w-full">
      <div className="relative rounded-2xl overflow-hidden group" style={{ boxShadow: '0 15px 50px rgba(0,0,0,0.3), 0 0 0 1px rgba(255,255,255,0.06)' }}>
        <img src={imageUrl} alt={caption || 'Creative'} className="w-full h-auto object-cover transition-transform duration-700 group-hover:scale-[1.02]" loading="lazy" decoding="async" />
        {/* Hover shine effect */}
