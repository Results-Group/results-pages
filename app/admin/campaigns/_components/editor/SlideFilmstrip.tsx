  ...
  return (
    <div className="flex flex-col gap-2">
      <div className="flex items-center justify-between px-1 mb-1">
        ...
        <span className="text-[10px] font-bold px-1.5 py-0.5 rounded" style={{ color: '#40e1d3', background: 'rgba(64,225,211,0.1)' }}>{sections.length}</span>
      </div>
      ...
      <button
        onClick={onAdd}
        className="flex items-center justify-center gap-1.5 mt-1 px-3 py-2.5 rounded-xl text-xs font-bold transition-all duration-200"
